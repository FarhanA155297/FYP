...
<body>
  ...
  <table class="table table-striped table-bordered">
      ...
      <tr>
        ...
        <td>
          <a href="customers.php?edit=<?php echo $readrow['no_matrik']; ?>" class="btn btn-success btn-xs" role="button"> Edit </a>
          <a href="customers.php?delete=<?php echo $readrow['no_matrik']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
        </td>
      </tr>
      <?php } 
        $conn=null;
